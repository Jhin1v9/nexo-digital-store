...
**Fonte:** drive-download-20260628T170401Z-3-001.zip > Apps-Webs - 2026/PORTAFOLIO APLICACIONES CRM Y ERP - 2026/APLICACIONES CRM Y ERP/ERD - Empresas/ERP_FARMACIA

**PDF:** documentacion_sistema.md.pdf
...
El sistema ha sido desarrollado utilizando el stack **LEMP** (Linux, Nginx, MySQL, PHP) con el
...
*
Descargar e instalar [Laragon](https://laragon.org/) o [XAMPP]
...
Se sugiere un VPS (Droplet) de $4 o $6 mensual. Ofrece control total sobre el servidor PHP y
MySQL.
...
file:///C:/CRMyERP/erp-farmacia/documentacion_sistema.md
